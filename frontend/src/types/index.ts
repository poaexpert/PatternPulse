...
export type ActiveView = 'dashboard' | 'scanner' | 'alerts' | 'watchlist' | 'settings' | 'ai-analysis' | 'futures' | 'journal' | 'news' | 'earnings' | 'calendar' | 'heatmap' | 'pattern-scanner' | 'risk-calc' | 'multi-tf' | 'crypto' | 'paper-trade' | 'screener' | 'options';
